...
# for title
        ...
        img_chat=img_chat.resize((200,70)Img_chat.ANTILIAS)
        self.photoimg=ImageTK.PhotoImage(img_chat)


        Title_label=Label(main_frame,bd=3,relief=RAISED,anchor='nw',width=730,compound=LEFT,images=self.photoimg,text='CHAT ME',font=('arial',30,'bold'),fg='green',bg='white'))
